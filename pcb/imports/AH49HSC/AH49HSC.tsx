...
export const AH49HSC = (props: ChipProps<typeof pinLabels>) => {
    return (
        <chip
            pinLabels={pinLabels}
            supplierPartNumbers={{
            ...
            cadModel={{
                objUrl: "https://modelcdn.tscircuit.com/easyeda_models/assets/C510723.obj?uuid=cefd4596db214da394d9632b2b88f8f2",
                stepUrl:
                    "https://modelcdn.tscircuit.com/easyeda_models/assets/C510723.step?uuid=cefd4596db214da394d9632b2b88f8f2",
